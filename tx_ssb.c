// tx_sine_nco.c
// Generate a sine at RF using LimeSDR NCO (baseband DC -> NCO mixing).
// Usage examples:
//   ./tx_sine_nco --lo 30M --nco 1.5M --tx-gain 40
//   ./tx_sine_nco --host-sr 5M --oversample 32 --tx-lpf-bw 20M --lo 100M --nco 25M --calibrate on
//
// Notes:
// - We always print the "calibrated params" after (optional) calibration.
// - The NCO makes the tone; we purposely transmit a constant I/Q (DC).
// - Ctrl+C to stop.
